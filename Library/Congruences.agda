...
⋂-cong P = record {
              ...
              ; cequiv = λ s → record { refl = λ C PC → refl (cequiv C s)
...
open import Relation.Binary.Construct.Always as A
open import Data.Unit.Polymorphic
∇ : ∀ ℓ → Congruence {ℓ₃ = ℓ} A
∇ ℓ = record { rel = λ s → Always {A = ∥ A ⟦ s ⟧ₛ ∥ }
           ; welldef = λ _ _ _ → tt

...
terms without variables. Given a signature \AgdaBound{Σ} and
...
a family of variables, we define a new signature extending \AgdaBound{Σ} with
\AgdaBound{X} by taking the variables as new constants (i.e. , operations with
...
\begin{code}
  ...
  %
  \>[2]\AgdaOperator{
    \AgdaFunction{\AgdaBound{Σ}\AgdaSpace{}
      〔\AgdaSpace{}\AgdaBound{X}\AgdaSpace{}〕}
  }
  \AgdaSpace{}%
  \AgdaSymbol{=}\AgdaSpace{}%
  \AgdaKeyword{record}

...
% In yet another direction, it would be interesting to formalize
% algebras of binding structures as proposed by
% \cite{fiore-2010}. Capretta's and Felty's
% \citeyearpar{capretta/felty:2009} formalization of higher-order
% algebras might be an interesting starting point. The interest 

...
\begin{abstract}
  ...
  the framework of heterogeneous universal agebras. Although this is a
  ...
  to define languages and their semantics via initial algebra semantics.
  The key to defining a correct compiler within this approach is to be able to translate
  algebras of the target signature to the source signature. This concept
  is known as \emph{derived signature morphism}, and as far as we know,
  this is the first formalization in type-theory of it.

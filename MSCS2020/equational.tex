...
terms, \ie terms without variables. Given a signature \AgdaBound{Σ} and \AgdaBound{X}\AgdaSpace{}\AgdaSymbol{:}\AgdaSpace{}\AgdaField{sorts}\AgdaSpace{}\AgdaBound{Σ}\AgdaSpace{}\AgdaSymbol{→}\AgdaSpace{}\AgdaPrimitiveType{Set} a family of variables, we define a new signature
extending \AgdaBound{Σ} with \AgdaBound{X} by taking the variables as new constants

...
module TX-is-Free (X : Vars Σ) where
  ...
  module TExtFX = InitHomoExt FX θ⁼¹
  module TExt = InitExtId {Σ} X
  ...
  H⁼¹∘H≈Id = TExt.H≈idFX (H ∘y H⁼¹) (λ s x → PE.refl)

  TX≅FX : TX ≅ FX
  TX≅FX = record { iso = iso-intro H⁼¹ H H∘H⁼¹≈Id H⁼¹∘H≈Id }
    where open IsoProp {A = TX} {FX}

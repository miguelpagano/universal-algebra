...
\eqref{eq:opclosed}.  Let \AgdaBound{Σ} be a signature and
\AgdaBound{A} be an algebra for \AgdaBound{Σ}.\footnote{The notation
  \AgdaBound{A}\AgdaSpace{}%
  \AgdaOperator{\AgdaFunction{∥}}\AgdaSpace{}\AgdaBound{s}\AgdaSpace{}\AgdaFunction{∥}
  corresponds to the carrier of the setoid \AgdaBound{A}\AgdaSpace{}%
  \AgdaOperator{\AgdaFunction{⟦}}\AgdaSpace{}\AgdaBound{s}\AgdaSpace{}\AgdaFunction{⟧ₛ}.}
...
\AgdaBound{A}\AgdaSpace{}\AgdaFunction{∥}\AgdaSpace{}\AgdaBound{s}\AgdaSpace{}\AgdaFunction{∥}; operations are interpreted just as in \AgdaBound{A} and the congruence proof
...
\newcommand{\tsigmaeq}[1]{\AgdaOperator{\AgdaFunction{T}\AgdaSpace{}\AgdaBound{#1}\AgdaSpace{}%
\AgdaFunction{〔}\AgdaSpace{}%
\AgdaBound{X}\AgdaSpace{}\AgdaFunction{〕}}}
